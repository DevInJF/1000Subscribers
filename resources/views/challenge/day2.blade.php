...
<section class="hero">
    <div class="row">
        <div class="small-12 columns">
        	<h3 class="subheader">List-Building Challenge Day 2:</h3>
            <h1>What Makes Great Content Great?</h1>
            <h2 class="subheader">Hacking the Secrets of Great Content</h2>
        </div>
    </div>
</section>
<section class="content article">
	<div class="row">
		<div class="small-12 columns">
			...
			<p>Every blog post you write needs to be extremely useful. If it isn&rsquo;t then you have just wasted the reader&rsquo;s time.</p>
			<p>This means that you need to consider the reader. Remember, it is about them, not you.</p>
			<p>Everything about the post should center around the reader. What are their needs, wants, hopes, and dreams? What problems do they have in their daily lives that you can solve?</p>
			<p>Now you choose a topic that will solve one of their problems. Help them achieve something that they&rsquo;ve always wanted to achieve.</p>
			<h3>Plan It Out</h3>
			<p>I have two methods to writing content:</p>
			<ol>
			...
			<p>Writing an outline for your posts will allow you to see which points you want to cover and the best order in which to cover them in.</p>
			<h3>Headlines Are the Neon Signs</h3>
			<p>Great headlines pull people in. Mediocre headlines make people think twice about clicking the link.</p>
			<p>Sites like <a href="http://buzzfeed.com">Buzzfeed</a> have mastered the clickbait headlines. You don&rsquo;t have to go to the crazy extremes that they do, but you can learn a thing or two about how they approach headline creation.</p>
			<p>A great headline clarifies exactly what your blog post is about.</p>
			<p>You should try your best to write your headline first so you understand what the main point of your post will be. It doesn&rsquo;t need to be the final headline, but it has to be something that keeps you focused.</p>
			<p>The few words that you do use in your post title will be the most important words you ever use for a blog post.</p>
			<p>Why?</p>
			<p>Well, think about it. How do people get to your site? It&rsquo;s usually through Google or some social media platform. They don&rsquo;t see the full blog post. All they see is the post title. That is where they make their decision on whether or not they are going to invest their time with you.</p>
			<p>If the headline is catchy, they&rsquo;ll click over to read more. If it&rsquo;s not then you&rsquo;ve lost a reader before they even stepped through the door.</p>
			<p>So how do you write great headlines?</p>
			<p>The American Writers &amp; Artists teach the Four U&rsquo;s approach to writing awesome headlines.</p>
			<ol>
				<li>Be USEFUL to the reader</li>
				<li>Provide them with a sense of URGENCY</li>
				<li>Convey the idea that the main benefit is somehow UNIQUE</li>
				<li>Do all of the above in an ULTRA-SPECIFIC way</li>
			</ol>
			<p>That is a good start, but we want a little bit more to work with. Copywriter Clayton Makepeaces believes that you should ask yourself six questions before you start to write your headline:</p>
			<ol>
				<li>Does your headline offer the reader a reward for reading?</li>
			...
			<p>Once you do that you can move on to the purpose of the post and explain how it will address the problem the reader is having. This ensures that the reader has a reason to continue reading.</p>
			<p>Here is an example of a great intro to a blog post:</p>
			<blockquote>
				<p>Know what&rsquo;s tougher than creating great content?</p>
				<p>Creating it at scale.</p>
			...
			<p>It&rsquo;s hard for your reader to make a decision on whether or not a post is going to be worth their time if they can&rsquo;t easily digest it to take some key points from it.</p>
			<p>Don&rsquo;t make your reader burrow through paragraphs to try and decipher what the post is about. They won&rsquo;t do it. They have better things to do.</p>
			<p>Making your post scannable means that your reader can quickly glance through the post and pick up the main points. These main points will dictate whether or not they stick around.</p>
			<p>The best ways to break up content to make it scannable are:</p>
			<ul>
				<li>lists</li>
				<li>subheadings</li>
				<li>block quotes</li>
			...
			<p>Place these things strategically throughout your post and you&rsquo;ve made things much easier for your readers.</p>
			<h3>Be Human</h3>
	...
	<div class="row">
		<div class="small-12 columns">
			<ul class="no-bullet days">
				...
				<li class="active">Day 2: <span>Reverse Engineering Great Content</span></li>
				<li class="passive">Day 3: <span>The Power of Guest Posting</span></li>
