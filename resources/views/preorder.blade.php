  ...
  <div class="row">
      ...
      <div class="small-12 large-6 columns">
        ...
        <ul>
          ...
          <li>Get featured on other blogs to use their traffic for your own gain</li>
      ...
      <div class="small-12 large-6 columns">
        <p>Some people think you need to wait months or years before making money with your blog.</p>
        <p>Wrong.</p>
        <p>Pinterest allows you to get an instant bolt of traffic that will help you make money from day 1.</p>
        <p>In fact, <strong>I made $1,000 in the first 60 days using Pinterest</strong> and I didn&rsquo;t have to resort to ads.</p>
        <p>In this course you will learn how to:</p>
        <ul>
          <li>Setup your Pinterest profile for success</li>
...
<section class="content">
  <div class="row">
      <div class="small-12 columns">
        <h2 class="text-center">That&rsquo;s $691 of course value for just $147</h2>
        <h3 class="text-center subheader">Pssst, that&rsquo;s $544 off (79%)</h3>
      </div>
      <div class="small-12 large-6 large-offset-3 columns end">
...
<section class="content gray">
  <div class="row">
      ...
      <div class="small-12 large-6 large-offset-3 columns end">
        ...
        <p>If you have any questions about anything, just shoot an email to <a mailto="scrivs@obstacle.co">scrivs@obstacle.co</a>.</p>
      </div>
    </div>
</section>
<section class="cta">
